...
export const metadata: Metadata = {
  title: "DLC Tecnológica | Seguridad Electrónica, Domótica y Automatización en Ecuador",
  description: "Líderes en seguridad electrónica (CCTV, alarmas, control de accesos), puertas automáticas, redes estructuradas, Smart Home, diseño eléctrico y energías renovables en Ecuador.",
  keywords: [
