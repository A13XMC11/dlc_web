...
import {
  Flame, Fingerprint, Home, Bell, Camera, DoorOpen, Zap, Wrench, Code2,
} from "lucide-react";
import { serviciosData } from "./servicios-data";
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {serviciosData.map((service, index) => {
        const IndexIcon = INDEX_ICON_MAP[service.indexIconName];
        return (
          <motion.div
            key={service.slug}
            ...
            >
              ...
              <div className="mt-6 pt-5 border-t border-[#242424]/80 flex items-center gap-2">
                ...
                <span className="text-xs text-slate-400 font-sans">
                  {service.subcategories.length} soluciones disponibles
                </span>
              </div>
